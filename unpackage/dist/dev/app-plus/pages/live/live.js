  ...
  return _c(
    ...
    [
      _c(
        ...
        { staticClass: ["page"] },
        [
          _vm.detail.status !== 0 && _vm.detail.status !== 3
            ? _c("u-video", {
                staticClass: ["flex-1"],
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _fGift = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-gift.vue */ 10));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 16));\nvar _fDanmu = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-danmu.vue */ 33));\nvar _request = _interopRequireDefault(__webpack_require__(/*! @/common/js/request.js */ 52));\nvar _config = _interopRequireDefault(__webpack_require__(/*! @/common/js/config.js */ 53));\nvar _vuex = __webpack_require__(/*! vuex */ 54);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =\n\n\n{\n  components: {\n    fGift: _fGift.default,\n    uniPopup: _uniPopup.default,\n    fDanmu: _fDanmu.default },\n\n  data: function data() {\n    return {\n      statusBarHeight: 0,\n      content: '',\n      isFocus: false,\n      gifts: [],\n      giftActiveId: 0,\n      id: 0,\n      detail: {\n        \"created_time\": \"\",\n        \"id\": 0,\n        \"title\": \"\",\n        \"cover\": \"\",\n        \"user_id\": 0,\n        \"look_count\": 0,\n        \"coin\": 0,\n        \"key\": \"\",\n        \"status\": 0,\n        \"userId\": 0,\n        \"user\": {\n          \"avatar\": \"\",\n          \"id\": 0,\n          \"username\": \"\" } },\n\n\n      sign: \"\" };\n\n  },\n  computed: _objectSpread(_objectSpread({},\n  (0, _vuex.mapState)({\n    socket: function socket(state) {return state.socket;},\n    token: function token(state) {return state.token;} })), {}, {\n\n    src: function src() {\n      if (this.detail.key == '' || this.sign == '') return '';\n      return \"http://192.168.42.180:23483/live/\".concat(this.detail.key, \".flv?sign=\").concat(this.sign);\n    } }),\n\n  onLoad: function onLoad(e) {var _this = this;\n    var res = uni.getSystemInfoSync();\n    this.statusBarHeight = res.statusBarHeight;\n    // 获取当前直播间id\n    this.id = e.id;\n    // 请求直播间数据\n    _request.default.get('/live/read/' + this.id).then(function (res) {\n      __f__(\"log\", res.data, \" at pages/live/live.nvue:192\");\n      _this.detail = res.data;\n      _this.sign = res.sign;\n\n      __f__(\"log\", _this.detail.status, \" at pages/live/live.nvue:196\");\n    });\n\n    // 请求礼物列表\n    _request.default.get('/gift/list').then(function (res) {\n      res.map(function (item) {\n        item.image = _config.default.baseUrl.replace('/api', '') + item.image.replace(/^http:\\/\\/[^/]+/, \"\");\n      });\n      _this.gifts = res;\n    });\n\n    // 加入直播间\n    this.joinOrLeaveLive('join');\n  },\n  methods: {\n    // 打开输入框\n    openInput: function openInput() {var _this2 = this;\n      this.$store.dispatch('authMethod', function () {\n        _this2.$refs.input.open();\n      });\n      this.isFocus = true; // 聚焦\n    },\n    // 发送弹幕\n    submit: function submit() {\n      if (this.content === '') return;\n      this.$refs.danmu.send({\n        id: this.$refs.danmu.list.length + 1,\n        name: 'Gene',\n        content: this.content });\n\n      this.content = '';\n      this.$refs.input.close();\n    },\n    // 发送礼物\n    sendGift: function sendGift() {var _this3 = this;\n      if (this.giftActiveId === 0) {\n        return uni.showToast({\n          title: '请选择礼物',\n          icon: 'none' });\n\n      }\n      var index = this.gifts.findIndex(function (item) {return item.id === _this3.giftActiveId;});\n      if (index === -1) return;\n      var g = this.gifts[index];\n      this.$refs.gift.send({\n        username: \"Gene\",\n        avatar: \"\",\n        gift_name: g.name,\n        gift_image: g.image,\n        num: 1 });\n\n      this.$refs.giftPopup.close();\n    },\n    back: function back() {\n      uni.navigateBack({\n        delta: 1 });\n\n    },\n    // 充值\n    openCoin: function openCoin() {\n      uni.navigateTo({\n        url: \"../coin/coin\" });\n\n    },\n    // 加入或离开直播间  join leave\n    joinOrLeaveLive: function joinOrLeaveLive(type) {\n      if (this.socket && this.token) {\n        this.socket.emit(type + 'Live', {\n          live_id: this.id,\n          token: this.token });\n\n      }\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///51\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _default = {\n\n  // baseUrl:\"http://10.130.133.27:7001/api\",\n  baseUrl: \"http://192.168.42.75:7001/api\",\n\n\n\n\n  // 拉流前缀\n  livePlayBaseUrl: \"http://192.168.42.75:7001/live\",\n  // 推流前缀\n  livePushBaseUrl: \"rtmp://192.168.42.75:7001/live\",\n  // socket\n  socketUrl: \"http://192.168.42.75:7001\"\n\n  // 192.168.42.18 手机网络\n  // 工作电脑ip 10.130.133.27\n};exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///53\n");
